...
python $scriptdir/combine.py - receiver.json combined.json
...
python $scriptdir/filter.py combined.json pointcloud_sizes.csv '"PointCloudRenderer" in component' sessiontime component=points_per_cloud
python $scriptdir/plot.py pointcloud_sizes.csv
#
# Graph latencies
python $scriptdir/filter.py combined.json pointcloud_latencies.csv '"PointCloudRenderer" in component' sessiontime component=latency_ms
